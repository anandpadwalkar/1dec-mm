                                ...
                                <fieldset>
                                  <div class="form-group">
                                    <div class="input-group">
                                      ...
                                      <!--EMAIL ADDRESS-->
                                      <input id="emailInput" placeholder="email address" class="form-control" name="email" type="email" required="true">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <input class="btn btn-lg btn-primary btn-block" value="Send My Password" type="submit" onclick="return status()" >
                                  </div>
                                </fieldset>
                              </form><!--/end form-->
